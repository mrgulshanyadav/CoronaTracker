...
import 'dart:convert';
import 'dart:async';
import 'Response/TotalResponse.dart';
        ...
        FutureBuilder(
          ...
          builder: (context, snapshot){
            ...
            if(!snapshot.hasData){
              ...
              TotalResponse totalResponse = TotalResponse.fromJson(snapshot.data[0][0]);

              String confirmed = totalResponse.confirmed;
              String recovered = totalResponse.recovered;
              String deaths = totalResponse.deaths;
              String active = (int.parse(confirmed) - int.parse(recovered) - int.parse(deaths)).toString();
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Container(alignment: Alignment.topLeft, child: Text('Confirmed: ' + confirmed, style: TextStyle(fontSize: 18, color: Colors.black))),
                                Container(alignment: Alignment.topLeft, child: Text('Recovered: ' + recovered, style: TextStyle(fontSize: 18, color: Colors.blue[700]))),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: <Widget>[
                                Container(alignment: Alignment.topLeft, child: Text('Deaths: ' + deaths, style: TextStyle(fontSize: 18, color: Colors.red[700]))),
                                Container(alignment: Alignment.topLeft, child: Text('Active: ' + active, style: TextStyle(fontSize: 18, color: Colors.green[700]))),
                              ],
                            ),
                          ),
                        ],
